...
define KernelPackage/iio-hdc100x
  SUBMENU:=$(OTHER_MENU)
  DEPENDS:=kmod-i2c-core kmod-iio-core
  TITLE:=HDC1000x  HDC1080 driver(temperature sensor)
  KCONFIG:= \
	CONFIG_HDC100X=m
  FILES:=$(LINUX_DIR)/drivers/iio/humidity/hdc100x.ko
  AUTOLOAD:=$(call AutoLoad,56,hdc100x)
endef

define KernelPackage/iio-hdc100x/description
 support for HDC Devices:
 hdc100x， hdc1080
endef

$(eval $(call KernelPackage,iio-hdc100x))
